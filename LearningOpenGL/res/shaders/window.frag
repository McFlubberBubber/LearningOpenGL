...
void main ()
{
	...
	//getting the alpha value from the texture
	float alpha = texture(u_material.textureDiffuse1, fs_input.texture_coords).a;
	FragColor = vec4(mixed_result, alpha);		//actual alpha value
}
